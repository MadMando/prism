...
vector store — it works on top of any existing LanceDB corpus without
re-embedding or re-indexing. When no graph is available, it degrades
gracefully to standard vector retrieval.
...
\begin{itemize}[leftmargin=*]
  ...
  \item An open-source Python library with a LanceDB adapter, CLI, and a
