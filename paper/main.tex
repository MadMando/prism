...
\textsc{implements}     & positive    & 0.75 & $p_i$ concretely realises the concept in $p_j$ \\
...
weight $w(r) \cdot c_{ij}$ in the serialised graph).  Activation
\emph{accumulates} across all incoming neighbours, so nodes corroborated
